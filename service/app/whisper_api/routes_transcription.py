...
async def task_handler():
    while True:
        ...
        try:
            ...
            task_status[task_id]["result"] = transcription
...
async def get_transcription(file: str, user_id: int, record_id: int, model: str = "base", secret_key: str | None = Header(default=None)):
